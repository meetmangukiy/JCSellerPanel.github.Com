...
! function($) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (hasOptions && options.customTemplate) {
            DRPTemplate = '<div class="daterangepicker customTemplate dropdown-menu">' +
                '<div class="ranges">' +
                '<div class="range_inputs">' +
                ...
                '<button class="btn btn-sm ' + this.applyClass + ' applyBtn" disabled="disabled"><i class="glyphicon glyphicon-ok"></i></button>&nbsp;' +
                '<button class="btn btn-sm ' + this.cancelClass + ' cancelBtn"><i class="glyphicon glyphicon-remove"></i></button>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '<div class="calendar right"></div>' +
            ...
            // overwrite given options, necessry for proper css
            options.opens = 'right';
        }
    ...
    DateRangePicker.prototype = {
        ...
        hide: function(e) {
            ...
            //			commentted to allow same dates
